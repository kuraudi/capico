...
function Page() {
    ...
    const { setRole } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$GlobalContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGlobalContext"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://127.0.0.1:8000/userauth/register/", {
                email,
                password
            }, {
    ...
    const handleGo = async (e)=>{
        e.preventDefault();
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://127.0.0.1:8000/userauth/", {
                withCredentials: true
            });
...
//# sourceMappingURL=src_app_365036._.js.map